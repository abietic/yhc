...
# CI smokes: assemble native unpacked apps without producing release media.
...
desktop-unpacked-crash-containment-smoke-darwin-amd64: desktop-package-smoke-darwin-amd64
	node desktop/scripts/unpacked_lifecycle_smoke.cjs --app desktop/dist/mac/YHC.app/Contents/MacOS/YHC --crash-backend
...
desktop-unpacked-crash-containment-smoke-linux-amd64: desktop-package-smoke-linux-amd64
	node desktop/scripts/unpacked_lifecycle_smoke.cjs --app desktop/dist/linux-unpacked/yhc-desktop --crash-backend

desktop-unpacked-crash-containment-smoke-linux-amd64-ci: desktop-package-smoke-linux-amd64
	node desktop/scripts/unpacked_lifecycle_smoke.cjs --app desktop/dist/linux-unpacked/yhc-desktop --crash-backend --no-sandbox

desktop-unpacked-active-turn-crash-smoke-linux-amd64: desktop-package-smoke-linux-amd64
	node desktop/scripts/unpacked_lifecycle_smoke.cjs --app desktop/dist/linux-unpacked/yhc-desktop --crash-active-turn

desktop-unpacked-active-turn-crash-smoke-linux-amd64-ci: desktop-package-smoke-linux-amd64
	node desktop/scripts/unpacked_lifecycle_smoke.cjs --app desktop/dist/linux-unpacked/yhc-desktop --crash-active-turn --no-sandbox
