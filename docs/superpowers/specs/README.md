...
|---|---|---|
| [`2026-08-09-yhc-public-release-design.md`](2026-08-09-yhc-public-release-design.md) | Clean public repository, private archive, identity compatibility, source-mapping retention, and publication gates | Approved; implementation plan pending |
