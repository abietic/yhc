...
|---|---|---|
| [`2026-08-13-untracked-sbom-design.md`](2026-08-13-untracked-sbom-design.md) | Remove the committed SBOM while retaining open-source licensing and fail-closed dependency-license checks | Accepted; implementation pending |
