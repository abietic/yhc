...
| [`p51-2-auto-containment-admission.md`](p51-2-auto-containment-admission.md) | P51.2 exact Guest identity, routine Auto prompt reduction, critical fresh-AllowOnce constraint, ProjectGraph/client propagation, hook-rewrite restart, dispatch/submission drift rejection, child derivation, real Darwin containment, race, and repository-gate evidence. |
