...
credentials, hooks/MCP, and missing hard resource limits. P51.2 passed its
separate public intake and is the sole Ready slice, but is not implemented.
...
| Contract | Outcome |
|---|---|
| [`p51-2-auto-containment-admission.md`](p51-2-auto-containment-admission.md) | Active executable contract; P51.2 is Ready, G28 remains open, and runtime behavior is unchanged until implementation closes. |
...
| [`p42-host-execution-containment.md`](p42-host-execution-containment.md) | P42.0 completed the immutable compatibility seam; P51.1 delivered the P42.1 Darwin Guest binding subset, while G28 remains open and P51.2 is Ready but not implemented. |
