...
// Modified by YHC from acp-go-sdk v0.13.5: ContentBlock JSON marshaling
// preserves _meta and annotations for every supported block variant.
...
func (u ContentBlock) MarshalJSON() ([]byte, error) {
	if u.Text != nil {
		...
		m["type"] = "text"
		{
			...
			nm["type"] = "text"
			nm["text"] = m["text"]
			if _v, _ok := m["_meta"]; _ok {
				nm["_meta"] = _v
			}
			if _v, _ok := m["annotations"]; _ok {
				nm["annotations"] = _v
			}
